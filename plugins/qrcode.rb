module Jekyll
  class QRCode < Liquid::Tag
    ...
    def render(context)
        ...
        @img.img_info['src'] = "https://api.qrserver.com/v1/create-qr-code/?size=#{@size}&margin=5&color=165B94&data=#{url.start_with?('/') ? context.registers[:site].config['url']+url : url}"
